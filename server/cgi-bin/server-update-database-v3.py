...
c.execute('create table comments(id varchar(200) primary key not null, username varchar(200), created date, grammar text, parent varchar(200), root varchar(200))')
conn.commit()
